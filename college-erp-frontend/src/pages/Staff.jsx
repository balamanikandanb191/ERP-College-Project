        ...
        {!loading && filteredStaff.length > 0 && (
          <div className="px-6 py-4 border-t border-slate-100 flex items-center justify-between bg-slate-50/50">
            <span className="text-sm font-medium text-slate-500">
              Showing <span className="text-slate-800 font-bold">1</span> to <span className="text-slate-800 font-bold">{filteredStaff.length}</span> of <span className="text-slate-800 font-bold">{filteredStaff.length}</span> staff
            </span>
