              ...
              <td className="px-6 py-4 whitespace-nowrap">
                <div className="flex flex-col gap-1">
                  <span className={`inline-flex px-2.5 py-1 rounded-lg text-[10px] font-black uppercase tracking-wider ${
                    student?.admissionStatus === 'Approved' ? 'bg-emerald-100 text-emerald-700' : 
                  ...
                  <span className={`inline-flex px-2 py-0.5 rounded text-[9px] font-bold uppercase tracking-wider text-center ${
                    student?.feesPaid === 'Paid' ? 'text-emerald-500' : 'text-amber-500'
                  }`}>
